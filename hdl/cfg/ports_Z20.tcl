...
### Expansion header, including SPI, TX + RX gate, trig in + out
create_bd_port -dir O -from 6 -to 0 exp_p_tri_io
create_bd_port -dir I -type data exp_p_tri_i
...
### Clock forwarding
create_bd_port -dir O -type clock -from 3 -to 0 ext_clk_p_o
create_bd_port -dir O -type clock -from 3 -to 0 ext_clk_n_o
